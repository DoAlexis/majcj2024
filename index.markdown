...
The journey into understanding movie ratings begins with a global exploration by mapping ratings across countries and tracking their changes over time. Movies in our dataset span the past century and over nine regions for analysis. Fear not though, as the dynamic map below brings clarity to this vast analysis! With just a glance, you can explore how ratings for a specific genre evolve in a region of interest. For instance, comedy ratings in Australia were strikingly stable at a low score of 2 between 1940 and 1970. After this period, ratings soared, fluctuating around an average of 5. In contrast, comedy ratings in other countries during this era were highly erratic, visualized by the flickering map of rating colors during this thirty year interval. These spatial and temporal variations reveal that both features play a pivotal role in shaping movie ratings, and are interconnected with rating variations.


{% include_relative assets/plots/world-map.html %}


To bring clarity to rating fluctuations over geographies and time, the below global race of the frequency of movie production across our top 20 genres can be examined. This race reveals fascinating trends, such as how some genres, like drama, show a steady increase in production over time. We hypothesize this may saturate audiences and dampen enthusiasm for similar movies ratings. Hence, this race highlights that there is surely a time component of movie production frequency and thereby ratings that must be considered in our further analysis of movie ratings.


<iframe src="{{ '/assets/plots/bar-race.html' | relative_url }}"  style=" height: 630px; width: 100%; border: none;"></iframe> 

To further explore the dynamics of movie’s production, the below histograms provide genre-specific insights of production frequencies. With this, genres including comedy, romance, action, and mystery can be seen as having bimodal production patterns. Peaks emerged prominently between the 1990s and 2000s, coinciding with the technological revolution and the rise of digital media. Another notable peak appears in the 1920s, often associated with the film industry’s resurgence during the post-WWI “Roaring Twenties.” These dual peaks suggest that historical and technological contexts play a crucial role in shaping production trends, which we hypothesize may in turn impact ratings. This temporal variation at the genre-specific levels underscores the importance of considering genres alongside movie production regions and release dates for further ratings analysis. 
